...
BarrowSpecies <- read.csv("BarrowPlantSpecies_with_site_names.csv", row.names = 1)
str(BarrowSpecies)

BarrowChemistry <- read.csv("BarrowPlantChemistry_with_site_names.csv", row.names = 1)
str(BarrowChemistry)
